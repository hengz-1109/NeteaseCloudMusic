...
function verifyCodeIsReady() { 
    draw(show_num);
    var top = $(".input--verify_code").css("margin-top");
    var height = $(".input--verify_code").css("height");
    $("#login-verify-code-canvas").css("top",top);
    $("#login-verify-code-canvas").css("height",height);
